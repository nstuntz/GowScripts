...
Func CollectAthenaGiftMS($MScount = 0)
   ...
   PollForColors($MSAthenaGiftCollectButton[0],$MSAthenaGiftCollectButton[1],$MSSecretGiftCollectButtonColors,4000,"$MSSecretGiftCollectButtonColor at $MSSecretGiftCollectButton")
...
Func CollectSecretGiftMS()
   ...
   ;Just a pause to speed it up
   If PollForColors($MSSecretGiftCollectButton[0],$MSSecretGiftCollectButton[1],$MSSecretGiftCollectButtonColors,4000,"$MSSecretGiftCollectButtonColor at $MSSecretGiftCollectButton") Then
...
Func ClickGoldButtonMS()
   ...
   For $MSi = 0 To 8 Step 1
	  ...
	  EndIf
	  Sleep(500)
	  If (PollForPixelSearch($MSGoldSearchLeft,$MSGoldSearchTop,$MSGoldSearchRight,$MSGoldSearchBottom, $MSBuyGoldColor, 1000)) Then
		 Send("{ESC}")
		 Return True
	  EndIf
	  If (PollForPixelSearch($MSGoldSearchLeft,$MSGoldSearchTop,$MSGoldSearchRight,$MSGoldSearchBottom, $MSBuyGoldColor2, 1000)) Then
		 Send("{ESC}")
		 Return True
	  EndIf
	  If (PollForPixelSearch($MSGoldSearchLeft,$MSGoldSearchTop,$MSGoldSearchRight,$MSGoldSearchBottom, $MSBuyGoldColor3, 1000)) Then
		 Send("{ESC}")
		 Return True
	  EndIf
   Next
