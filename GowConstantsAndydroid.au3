...
Global Const $GOWIcon[] = [152,317]
Global Const $GOWColor = 4006419
;StartupScript
...
Global Const $UserNameTextBox = [338,338]
Global Const $UserNameTextBoxColor = 16777215
;Global Const $PasswordTextBox = [805,550]
Global Const $PasswordTextBox = [400,389]
;Global Const $LoginButton = [885,550]
Global Const $LoginButton = [425,455]
Global Const $LoginFailureButton = [670,495]
Global Const $FirstPinBox = [230,180]
Global Const $SecondPinBox = [315,180]
Global Const $PinBoxColor = 16777215

;Menus
Global Const $CityMenu = [156,773]
Global $CityScreenColor = 3682821 ;winter2014=1053712 ; Fall2014= 1050624 ; - Old standard one - 1051656     7377064
Global $MapMenuColor = 12114009 ;winter2014=4744320; fall2014 = 7888928 ; - Old Map Color 9471048   5788760
...
;More Menu
Global Const $MoreMenu = [565,770]
Global Const $RedeemButton = [952,642]
Global Const $AccountButton = [425,260]
;Global Const $LogoutButton = [1010,550]
Global Const $LogoutButton = [430,550]
Global Const $LogoutYesButton = [300,315]
...
Global Const $AllianceHelpHelpAllButton = [550,650]

Global Const $HelpButton = [568,628]
Global Const $HelpButtonColor = 14197887 ;6303776 ;4742248 ;3676168 ; 6303776       4221056
Global Const $NOHelpColor = 8669995
;Boucers
Global Const $AthenaGift = [271,605]
Global Const $NoAthenaGiftColor = 10730350
Global Const $AthenaGiftCollectButton = [411,500]
Global Const $SecretGift = [172,608]
Global Const $SecretGiftCollectButton = [411,458]
...
;Banking
Global Const $HelpTopMember = [575,260] ; Blue Color
Global Const $HelpNumberOffsetX = 60
Global Const $HelpSecondMember = [575,320] ; Blue Color
...
Global Const $HelpRSSMax[][] = [[424,186], _ ;Stone
								   [424,240], _ ;Wood
								   [424,294], _ ;Ore
								   [424,348], _ ;Food
								   [424,402]] ; Silver      Stone - Wood - Ore - Food - Silver  64 px offset

Global Const $DoneAmountEntryButton = [1142,223] ; Blue color
Global Const $RSSHelpButton = [530,620] ; Blue
Global Const $RSSOKButton = [666,325] ; Blue
Global Const $MarketLocation = [205,465] ; this is after being zeroed on the screen
Global Enum $eStone,$eWood,$eOre,$eFood,$eSilver
Global Const $MaxMarchesExceeded = [435,285]
...
Global Const $GoldExitButton = [500,70]
...
Global Const $GoldSearchTop = 640
Global Const $GoldSearchBottom = 750
