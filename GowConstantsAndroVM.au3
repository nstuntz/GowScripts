...
Global Const $GOWIcon[] = [355,185]
Global Const $GOWColor = 11702893
;StartupScript
...
;Menus
Global Const $CityMenu = [160,800]
Global $CityScreenColor = 10800229 ;winter2014=1053712 ; Fall2014= 1050624 ; - Old standard one - 1051656     7377064
Global $MapMenuColor = 12419114 ;winter2014=4744320; fall2014 = 7888928 ; - Old Map Color 9471048   5788760
...
;More Menu
Global Const $MoreMenu = [550,800]
Global Const $RedeemButton = [952,642]
Global Const $AccountButton = [405,255]
...
Global Const $AllianceHelpHelpAllButton = [550,670]

Global Const $HelpButton = [550,645]
Global Const $HelpButtonColor = 14659983 ;6303776 ;4742248 ;3676168 ; 6303776       4221056
Global Const $NOHelpColor = 12663823
;Boucers
Global Const $AthenaGift = [265,620]
Global Const $NoAthenaGiftColor = 4684836
...
;Banking
Global Const $HelpTopMember = [550,260] ; Blue Color
...
Global Const $HelpRSSMax[][] = [[414,175], _ ;Stone
								   [414,227], _ ;Wood
								   [414,278], _ ;Ore
								   [414,329], _ ;Food
								   [414,380]] ; Silver      Stone - Wood - Ore - Food - Silver  64 px offset

Global Const $DoneAmountEntryButton = [1142,223] ; Blue color
Global Const $RSSHelpButton = [515,630] ; Blue
Global Const $RSSOKButton = [500,285] ; Blue
Global Const $MarketLocation = [190,485] ; this is after being zeroed on the screen
...
Global Const $AccountButtonColor = 15658734
